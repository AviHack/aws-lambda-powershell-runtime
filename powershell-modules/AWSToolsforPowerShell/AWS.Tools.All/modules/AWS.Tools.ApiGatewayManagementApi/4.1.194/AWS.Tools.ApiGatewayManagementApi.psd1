#
# Module manifest for module 'AWS.Tools.ApiGatewayManagementApi'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.ApiGatewayManagementApi.dll'
    ...
    GUID = '806df5e2-5984-4207-a814-933147bfbd72'
    ...
    Description = 'The ApiGatewayManagementApi module of AWS Tools for PowerShell lets developers and administrators manage Amazon API Gateway Management API from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
This version of AWS Tools for PowerShell is compatible with Windows PowerShell 5.1+ and PowerShell Core 6+ on Windows, Linux and macOS. When running on Windows PowerShell, .NET Framework 4.7.2 or newer is required. Alternative modules AWSPowerShell.NetCore and AWSPowerShell, provide support for all AWS services from a single module and also support older versions of Windows PowerShell and .NET Framework.'
    ...
    FormatsToProcess = @(
        'AWS.Tools.ApiGatewayManagementApi.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.ApiGatewayManagementApi.Completers.psm1',
        'AWS.Tools.ApiGatewayManagementApi.Aliases.psm1'
    )
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCU7Gr0LHgXl3dm
# zwSTZlxT2tJHljHmGjT4swAHW6ZmIKCCFB0wggXAMIIEqKADAgECAhAP0bvKeWvX
...
# CH5Dt5AMcecwFuJZHhJUdXBzx6Eky87/WImqQKGTMA0GCSqGSIb3DQEBAQUABIIB
# gHgZsZxsRO17cdlyq3aMO3U5AS8cXweiHkIBloQAdrRKh8ZlVFzBTDhT4NiEJW1R
# M1w1DAu1RRA39F+vXMb0THuvJcNmUNOIMS6GcsWA71uEtFqDjJVGca3UDuV8+HYA
# l5ifY+1tI7eNLdk26tsv2u42CWZW6yvdpkr0ofcxZF9OD5EqmdqZaslhpr7h5zBm
# VH81c8C2eTp/4KnQpnY2ZJWrR0I44ZKOuj39t1jB+TpNuTrigpE3j++hFMSQyuoF
# v546LqASGamJJiR2t19eYorteukNYiRGC5cX90qU9P73XBboXFhgPbhZSO0lGyMP
# MaLjojRt3aCD3wt1cLEYpFC8ZxaYjJ295WnLgSI3ahZHLoST+EgkWRqJQeL2KbNc
# aZjmhsfqK/2ssBvg4y1oj+FzK5sYj8z3lraiOg/cPhZlVjMBR+nFeurJGLun5Iue
# iMG/D8O/HxD1wnP2A+Rz7nEfqdemeEGzGRC+M/QA/gnIe0C3wS9UGbvrpWPb0duN
...
# SAGG/WwHATAxMA0GCWCGSAFlAwQCAQUABCBivkRE3TUC/ii2TJ59M/Kkw1Dhk3Tb
# TCyiCyd6CkqClgIRAM4/2We97N8YR3KtQXPXhpsYDzIwMjIxMDI2MjEwNDExWqCC
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTIyMTAyNjIxMDQxMVowKwYLKoZI
# hvcNAQkQAgwxHDAaMBgwFgQU84ciTYYzgpI1qZS8vY+W6f4cfHMwLwYJKoZIhvcN
# AQkEMSIEINCoKZNaGx8tjacfnHESq97bixEERlKP7iufyX9T2BmXMDcGCyqGSIb3
# DQEJEAIvMSgwJjAkMCIEIMf04b4yKIkgq+ImOr4axPxP5ngcLWTQTIB1V6Ajtbb6
# MA0GCSqGSIb3DQEBAQUABIICADPWWjrPHB4M8CLe6fg4Y/GWj3b4Mys4zUGs63iF
# AhRAbYl1czZL8WcIPbrGbcuNzRcde0l3LZi09i6yAqGIYHt8J6RiRHmPTyGf8REh
# UCnKwL2loRIx4gRVrlov32BmsEsSMeCSMJD9VyFNyTQCzb4HTRaFXx7zNGhHayW0
# CFxA7PVuSW8eTb+STfFURNv9VQ/HF5CfMf00SvQ/p6xY29Z7CFIv4Ul6uI9tfKsC
# NF/koHYXZDP5wI5i0IYMT7oPbcM+FX1uGXrFvcIpevSK/FK+q67ebqkV+G7EoMcA
# tnGI14EEAe4SfZU3FNSmKv3Pmi0SL2JWimcNDyWTy9ycK8yGXrAaqWrbQLyhAjZv
# cMmMVdjkpdSCbY+0oOMBANJ/Wsk8XiRkQSzPOzYHBrU5w/MnOc05lqnTgbrElxit
# q0fs/zTMf7g7OSxp6uNOdApOfk/JzbpJRgJaImgGDcHSIR8HkkRsVxgLq1wtOk4n
# WnRfr9nc4mAhA2QxLFX74ia7EuuCYQZTnQOxguS1OcteDjptUYbJ7LQmYWDnX0ft
# dM62Gf8nsjhRFnMXpfIlluO7aibIftphi52Jm0759N/RW+dgXlgVC5GHdDoP4Rx9
# 8YdsCUI9qQRmiPyzKNcFjnGHRoqW0mTY209WdNCo5sp4YsUbmNCKeKeUWwC6NEan
# iFt7
