#
# Module manifest for module 'AWS.Tools.AmplifyBackend'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.AmplifyBackend.dll'
    ...
    GUID = '0CCD1033-B9AA-4DA0-8DE8-060BF4C215F1'
    ...
    Description = 'The AmplifyBackend module of AWS Tools for PowerShell lets developers and administrators manage Amplify Backend from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
This version of AWS Tools for PowerShell is compatible with Windows PowerShell 5.1+ and PowerShell Core 6+ on Windows, Linux and macOS. When running on Windows PowerShell, .NET Framework 4.7.2 or newer is required. Alternative modules AWSPowerShell.NetCore and AWSPowerShell, provide support for all AWS services from a single module and also support older versions of Windows PowerShell and .NET Framework.'
    ...
    FormatsToProcess = @(
        'AWS.Tools.AmplifyBackend.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.AmplifyBackend.Completers.psm1',
        'AWS.Tools.AmplifyBackend.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.AmplifyBackend.dll-Help.xml'
    )
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBN37VOQmAGFiUz
# jE1Z1BEVDAaQfGs6AfyLDVM6poRjI6CCFB0wggXAMIIEqKADAgECAhAP0bvKeWvX
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJ1M
# HTV35+kZqZLNXfcSP3jSySNTiGAf8D8dV5XDysk4MA0GCSqGSIb3DQEBAQUABIIB
# gBvOtbRMzFkpmGhrr+ovxQDaN/uSdZp/1jxpiL2L4uhDD9O7EJplDELyej3LgX4D
# 0LUkB3km5d9N0v91uvOSHZzSFcss8MkzIBejf011C8CbYdxXPX2IJim3xnRjqg0H
# MA/faPMYLYto3zDwDDfx6+hxzb1EcyTGarkpNQxl5khU6XMDRPryIn1v32HPGFMN
# QE3ggrhyHq0VqToHGDrLXTfgHA7Qk36IVmtlgfV2HNR+OK6RYQiqKFLgI1WrJXnp
# M1IpkNU7benJIP6BXlEsnGyZVukOVZlfKuIJbEe/vu3ZG/GjO12C/jfrO/6QoEDP
# kW6Ai0bgU03iK+5qIJuGQgvXTL8u57ljc+plEX+JGPB11WXZBCnpcXK7LiHVTZ/k
# 2cF3qKmMKifCqn2/9AuFcrLt00dLjKv0mfIbjuZhk5v5FyOOzcqfs2fHUMSmzjWf
# X8DFs0VwcNty10/hmnpZSC9qphcgU9js0FrQSfHzESLaMzNlTRlNJ8FaBv4NmH1y
# 46GCFz0wghc5BgorBgEEAYI3AwMBMYIXKTCCFyUGCSqGSIb3DQEHAqCCFxYwghcS
# AgEDMQ8wDQYJYIZIAWUDBAIBBQAwdwYLKoZIhvcNAQkQAQSgaARmMGQCAQEGCWCG
# SAGG/WwHATAxMA0GCWCGSAFlAwQCAQUABCDSqn+act0+6cVxaujHVD0uXX6f1Yrh
# Nh1ov7WkHbfYBQIQetnTVqagUgl+fbWyF59oRRgPMjAyMjEwMjYyMTA0MTBaoIIT
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjIxMDI2MjEwNDEwWjArBgsqhkiG
# 9w0BCRACDDEcMBowGDAWBBTzhyJNhjOCkjWplLy9j5bp/hx8czAvBgkqhkiG9w0B
# CQQxIgQgZIioX+ysAUofa4yZCGRz+ILMmskWQa/LEYRUuV+jwyEwNwYLKoZIhvcN
# AQkQAi8xKDAmMCQwIgQgx/ThvjIoiSCr4iY6vhrE/E/meBwtZNBMgHVXoCO1tvow
# DQYJKoZIhvcNAQEBBQAEggIAZ/7WHuOG+5N78vwPT4KmzLUhUaC4rp1UoGT/M6yF
# THBXLKFQcCYD+roYtJvfxAIPt1yIL03S5faomU6CHw/kZ7BfbVG2/ZUEW78d1SkA
# mJlrvVe/LVeuLhmfp7pBqc3a9jvGDA0bKBSIn4NV9M3GFfPpk/o9vWNIbz4p0hWG
# GTvryTh0Uef3mrvaCz5bM2EYxWFWhBeGRKQC94iAUW+M2r/51DFUwoACeYZ7cFp0
# cwA63erS0zYEGlGhFzBmKTJ5mihe7idJNnizLo24Iatnv32nCBA4beignWn+SSAs
# 7XphdUSVGGG8Rw9sLXd3eW/2ZkWWCgIpWEoOO1Ha7ozKKkTphiRv+oppRGS/Y6Tw
# aNyzViavbIEANeC1B3iZPcN5iuL05CBlb17um/jj/WdO3j+zkOLZJXRnSZ32WOZV
# kOP9SrPLXWLxtbCnG06ZI5cQm+LMuV+EJL61uEZd6oQm2yBa2KlD7oUu8erDrKy8
# o4fZ9SEkqVV+a7hfTQ/lO3+v2J/i/PkQJi9FkCJxHdiRuhKdea8vvbcyiQCfNeKM
# ssrZmVkdfzcKaDKTRgqAcCye8oS4mzqG9b+7PTReXDfBnfHTjKJf47yu0ypyMcZV
# kxkmf8ADVM0b7p6ABr8TMJiiPEgHMMfT9hLOurgDA946VkoNsqQ+gqo3pa831JW+
# OPw=
