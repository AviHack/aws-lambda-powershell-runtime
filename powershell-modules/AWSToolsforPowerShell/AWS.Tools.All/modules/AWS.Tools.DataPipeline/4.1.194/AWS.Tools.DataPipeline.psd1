#
# Module manifest for module 'AWS.Tools.DataPipeline'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.DataPipeline.dll'
    ...
    GUID = '68abcdca-cfe8-4bf4-bc5e-c290185f5a96'
    ...
    Description = 'The DataPipeline module of AWS Tools for PowerShell lets developers and administrators manage AWS Data Pipeline from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
This version of AWS Tools for PowerShell is compatible with Windows PowerShell 5.1+ and PowerShell Core 6+ on Windows, Linux and macOS. When running on Windows PowerShell, .NET Framework 4.7.2 or newer is required. Alternative modules AWSPowerShell.NetCore and AWSPowerShell, provide support for all AWS services from a single module and also support older versions of Windows PowerShell and .NET Framework.'
    ...
    FormatsToProcess = @(
        'AWS.Tools.DataPipeline.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.DataPipeline.Completers.psm1',
        'AWS.Tools.DataPipeline.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.DataPipeline.dll-Help.xml'
    )
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCuKLJ36Cc5fHu5
# gysqCAGyybz2n0T7nJdHk5Gz0P16NqCCFB0wggXAMIIEqKADAgECAhAP0bvKeWvX
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJo1
# L9Eg7nUZAD/IINXNnAqEdBUdt013l8r+62SiisczMA0GCSqGSIb3DQEBAQUABIIB
# gA5HfecRHmHpamUrRCFyoSZYrlg3hFnGh4/JC29saWsw7Ie9r4ylnSj39pQHXJvK
# Zq6oDl9c/vadiivuqhBaNaHl4FN897zz8Inn8Cfg7osC5lpMe18yXMWhmrqQmmWV
# PvTEFc0l3LWSRkjneeYz3DA7ixQeiUSB5S7KVUBFa6bHVng1HlAeYG+eEAzKdotg
# dlS3SL+coRNavgsyFDSlIjbt1xjuTPgfIwwAK2RUsm/fWpyZRXCMnj1u2ZXAyNt+
# QNGIGmmwqNbOSdl4Io+laEkbHMnTb556JttF5KgOiNEvJm4C0Tx+Ai39PcoWniqF
# LJJkEOmoSREwkXhPH9q9AenyP91JPFLzhg2gCxXt1MEYO7hOYLxAPe0fivSGgrg6
# aEz04iovkCFOiKm8/faqyYJ1LDeZhNvLW8Ns7by72vaxWUg3ENoRIh3Yba79+yMZ
# Zj2ueLDNYM0vDcntH01+NsnUz06PrqoiVrxfONzyCqsF1a3lIoJSAjTCZBMJxiMP
...
# SAGG/WwHATAxMA0GCWCGSAFlAwQCAQUABCADI8JVM77U1Nvg9e61wyOYGtN960Sk
# +GCnBgPbP9S+bwIRAMkKBo2PD/BwDBFG9qMcg2sYDzIwMjIxMDI2MjEwMzMwWqCC
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTIyMTAyNjIxMDMzMFowKwYLKoZI
# hvcNAQkQAgwxHDAaMBgwFgQU84ciTYYzgpI1qZS8vY+W6f4cfHMwLwYJKoZIhvcN
# AQkEMSIEIK5pMYdasPGoOvfz73zqzcmhqYoV3nub4IUwRGLP/cqYMDcGCyqGSIb3
# DQEJEAIvMSgwJjAkMCIEIMf04b4yKIkgq+ImOr4axPxP5ngcLWTQTIB1V6Ajtbb6
# MA0GCSqGSIb3DQEBAQUABIICACGdvWLdlbjP95Ks5qa5NHV8oPXcRLkGYPyggN35
# JInX8xOamCudSNot15Cq4Z0NGUJJnBnQdjB1Ex/i45Uh5ojBC1Ug91LuUxWzgHmb
# 8BLGSTbqXVrC1JCp72EAqX9PHg/g8xgC8nukcZnuVge6HHNxDOZqU5q41DTd7r/6
# 14Fd0eyn2DjWmmQjNtrEtHLhhnh5OhJ9sVJHrve+5vLernCQ3mgJrzQRk0C2LUaY
# BK5MiGGojOcnxx4otdErt1QaZtHK2PzPKaHIAhIjYSJf9Dwaz8+9zPvdZTQZ6B1m
# eDOHVCODsF7JvlHgcbpUFBriZ1uR56mjNRDyM4Mw123Ng2FJ+4THfCJOxPoqNO1G
# TnCtWi16afbsYFaEHW4RROpqVbS/caf94ARSFhN5hvUr+KBYO5HQr7fy+K5Mum3Q
# 92teHr4WhBkf+mqqbhLGMv+b4/TClYPidqHv4AABJrpHWvjXTLDJtp/QZt+o2q2b
# 0AtZa46FzN/mt8lyfkOmaPdq+gAXh27tQpRm0x3ZRMdWbfk6trByhrCLHiwyadj+
# YRif7f355e8zCM1IpnI5WvDNDmJNsYvL6CX3dyz1tRHa2QziKQbMeRDj0ddOAHf0
# JdqE1bH70CdwuIi5KKZUSWFhx+Z3Q3JQlMu156UYqiXQDlu31i9ReK9vnXNAbQVg
# 84XO
