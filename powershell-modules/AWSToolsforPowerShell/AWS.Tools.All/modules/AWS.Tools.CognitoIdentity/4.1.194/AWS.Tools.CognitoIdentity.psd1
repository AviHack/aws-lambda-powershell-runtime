#
# Module manifest for module 'AWS.Tools.CognitoIdentity'
#

@{
    # Script module or binary module file associated with this manifest
    RootModule = 'AWS.Tools.CognitoIdentity.dll'
    ...
    GUID = '34f70a63-4662-4c01-b841-1149530567f9'
    ...
    Description = 'The CognitoIdentity module of AWS Tools for PowerShell lets developers and administrators manage Amazon Cognito Identity from the PowerShell scripting environment. In order to manage each AWS service, install the corresponding module (e.g. AWS.Tools.EC2, AWS.Tools.S3...).
...
This version of AWS Tools for PowerShell is compatible with Windows PowerShell 5.1+ and PowerShell Core 6+ on Windows, Linux and macOS. When running on Windows PowerShell, .NET Framework 4.7.2 or newer is required. Alternative modules AWSPowerShell.NetCore and AWSPowerShell, provide support for all AWS services from a single module and also support older versions of Windows PowerShell and .NET Framework.'
    ...
    RequiredModules = @(
        @{
            ModuleName = 'AWS.Tools.SecurityToken';
            RequiredVersion = '4.1.194';
            Guid = 'b760f2e8-291f-4df4-bd69-3a615b47c8d4' },
        @{
    ...
    FormatsToProcess = @(
        'AWS.Tools.CognitoIdentity.Format.ps1xml'
    )

    # Modules to import as nested modules of the module specified in ModuleToProcess
    NestedModules = @(
        'AWS.Tools.CognitoIdentity.Completers.psm1',
        'AWS.Tools.CognitoIdentity.Aliases.psm1'
    )
    ...
    FileList = @(
        'AWS.Tools.CognitoIdentity.dll-Help.xml'
    )
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCFZUrR36C9mDqA
# b8WfrmAlmvIKoXCmfFPN8MBdWTbLJ6CCFB0wggXAMIIEqKADAgECAhAP0bvKeWvX
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBua
# KEFDrw45vlRI7QNTetCFUFCbq1HiOrEmQFhakX3gMA0GCSqGSIb3DQEBAQUABIIB
# gE7+eqMwNhWs+smgonFAMOkVNMem+iPk47ELU+wKy9Gx/h3W7ZZZ1ZfiSfNvlkrY
# ERNuXAW6BiEcCWWci3aokCJapuSG4xTTLFEwC0AzLphfrT3ln9yTYlaJUpWkwBAg
# xC6ZDo4/x0IQjONgBOTJPtI7JTJdqbId3im8zkzvx29fzQxQTG1E9dJc2FKGibX7
# V80zErNLQrPd7WbfFTJpSP5SmUKOY5hDWn8G7VVe53elwxVSjKzkQKh0Scwhw2p9
# mBO424J1MtFUjrROTfitv7KDsSfwJ8m1HywCKpaKrSxNaTMlGYOpJ2l3BAVrwgeL
# 6kyCPZJSkNK6c37o+0JL0dn4nvWPeL6L9rSb2LPEjYnajPtE8pDd5YprQ3W5bmRi
# zamhlA7APsN2SdoDoLLtNsuRqdh61AB8XRInrsplEUeYY9R8fqB6yuHW16bxgY6a
# kmMBRJ1D/nBIysTUCDU3RG7hDXnacj19fsDJREE1lYQ5d1ZMwgt8bPbplwhHQ0C7
# FaGCFz4wghc6BgorBgEEAYI3AwMBMYIXKjCCFyYGCSqGSIb3DQEHAqCCFxcwghcT
# AgEDMQ8wDQYJYIZIAWUDBAIBBQAweAYLKoZIhvcNAQkQAQSgaQRnMGUCAQEGCWCG
# SAGG/WwHATAxMA0GCWCGSAFlAwQCAQUABCDFu3C8j9pZfIduwZC2BkarRTWO6wqe
# hdQ3WEdojwAb4wIRANh2J1Abk39R+65VhtWVf9sYDzIwMjIxMDI2MjEwMzI0WqCC
...
# KoZIhvcNAQkQAQQwHAYJKoZIhvcNAQkFMQ8XDTIyMTAyNjIxMDMyNFowKwYLKoZI
# hvcNAQkQAgwxHDAaMBgwFgQU84ciTYYzgpI1qZS8vY+W6f4cfHMwLwYJKoZIhvcN
# AQkEMSIEIF3Tx6ahQu7vMMJMNSdcjVcu4ilv9YFY/TXON62U3SLRMDcGCyqGSIb3
# DQEJEAIvMSgwJjAkMCIEIMf04b4yKIkgq+ImOr4axPxP5ngcLWTQTIB1V6Ajtbb6
# MA0GCSqGSIb3DQEBAQUABIICAI8FdwrsYOzvdoNlfgnZEC5CECAtdT7fwulmQ/dF
# +Aift1yVoRNEcujBnf3U5wefmQuH99IYiPSmz5hTKneK63kZ9BTaGHJ+XN5xWfrE
# ohnWl1p4Y59jx6sU4kzUgTIkKF20goGInJmrYwRI2SejRe+nt8XBGxZ8un0i3Q5J
# r/g+b0cj5ZgwvpTRmfyTXr9SEOTUe34HL0K6XGMqSN3NCR2LOJLU/5YvbAlubrZn
# /OD15LWhYbl+Uq3jR60VbcgkASdSqRRFHJ/9t0sJSh3aiujEoW5T34eYRmYQUzZ8
# twnoJE4Mm1ueHol0KFdsdCarrhBXp3wwbeXr8pW8Swpffu3im79mzMDLL11dJmBd
# GZ/Tz+3cvUwZApcR5+JKFP7Pb0S1Yq2PlifyEcg5jKzGOWPl/T/O+I6KOUeAlejt
# O96zHOK74NSRduz25NqPKv7w0KWHIua3fwqkUrJ3KbL9HdE7NPHlufreS5Hd5xAp
# ixU5OrgXPolv2PJF5VXfJYJ1Nyv+2BgC9HrbokXjwxoHqBycztfELjUeeS4DIxHU
# 6k+RKcUPxyA9SeMlbyDTEDULY9xBc+rjqoDruf9JZEkIt7d5tRiL7iZ2hqhtXKLQ
# QhhxPPkM2uAs85gdE9Sw8skRBWYjZfHzfzSkTtQyHXUwri1M0GyJ6j9IY8SOyf6E
# f0jd
